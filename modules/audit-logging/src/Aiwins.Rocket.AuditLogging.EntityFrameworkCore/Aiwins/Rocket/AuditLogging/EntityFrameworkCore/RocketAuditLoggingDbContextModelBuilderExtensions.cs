...
namespace Aiwins.Rocket.AuditLogging.EntityFrameworkCore {
    public static class RocketAuditLoggingDbContextModelBuilderExtensions {
        public static void ConfigureAuditLogging (
            [NotNull] this ModelBuilder builder,
            Action<RocketAuditLoggingModelBuilderConfigurationOptions> optionsAction = null) {
            Check.NotNull (builder, nameof (builder));

            var options = new RocketAuditLoggingModelBuilderConfigurationOptions (
                RocketAuditLoggingDbProperties.DbTablePrefix,
                RocketAuditLoggingDbProperties.DbSchema
            );
