...
namespace Aiwins.Rocket.Users.EntityFrameworkCore {
    public static class RocketUsersDbContextModelCreatingExtensions {
        ...
        where TUser : class, IUser {
            ...
            b.Property (u => u.PhoneNumber).IsRequired ().HasMaxLength (RocketUserConsts.MaxPhoneNumberLength).HasColumnName (nameof (IUser.PhoneNumber));
            b.Property (u => u.PhoneNumberConfirmed).HasDefaultValue (false).HasColumnName (nameof (IUser.PhoneNumberConfirmed));
            b.Property (u => u.Email).HasMaxLength (RocketUserConsts.MaxEmailLength).HasColumnName (nameof (IUser.Email));
