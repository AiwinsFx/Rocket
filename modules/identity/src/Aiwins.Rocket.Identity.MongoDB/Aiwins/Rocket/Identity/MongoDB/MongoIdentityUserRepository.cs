...
namespace Aiwins.Rocket.Identity.MongoDB {
    public class MongoIdentityUserRepository : MongoDbRepository<IRocketIdentityMongoDbContext, IdentityUser, Guid>, IIdentityUserRepository {
        public MongoIdentityUserRepository (IMongoDbContextProvider<IRocketIdentityMongoDbContext> dbContextProvider) : base (dbContextProvider) { }
