...
namespace Aiwins.Rocket.Identity {
    ...
    public class RocketIdentityResultException : BusinessException, ILocalizeErrorMessage {
        ...
        public RocketIdentityResultException ([NotNull] IdentityResult identityResult) : base (
        ...
        public RocketIdentityResultException (SerializationInfo serializationInfo, StreamingContext context) : base (serializationInfo, context) {
