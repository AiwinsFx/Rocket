...
namespace Aiwins.Rocket.Identity {
    public class RocketIdentityOptionsFactory : RocketOptionsFactory<IdentityOptions> {
        protected ISettingProvider SettingProvider { get; }

        public RocketIdentityOptionsFactory (
            IEnumerable<IConfigureOptions<IdentityOptions>> setups,
            IEnumerable<IPostConfigureOptions<IdentityOptions>> postConfigures,
            ISettingProvider settingProvider) : base (setups, postConfigures) {
