...
namespace Aiwins.Rocket.PermissionManagement.EntityFrameworkCore {
    public static class RocketPermissionManagementDbContextModelBuilderExtensions {
        public static void ConfigurePermissionManagement (
            [NotNull] this ModelBuilder builder, [CanBeNull] Action<RocketPermissionManagementModelBuilderConfigurationOptions> optionsAction = null) {
            ...
            builder.Entity<PermissionGrant> (b => {
                ...
                b.Property (x => x.ProviderScope).HasMaxLength (PermissionGrantConsts.MaxProviderScopeLength).IsRequired ();
                b.Property (x => x.ProviderKey).HasMaxLength (PermissionGrantConsts.MaxProviderKeyLength).IsRequired ();

                b.HasIndex (x => new { x.Name, x.ProviderName, x.ProviderScope, x.ProviderKey });
            });
        }
    }
}