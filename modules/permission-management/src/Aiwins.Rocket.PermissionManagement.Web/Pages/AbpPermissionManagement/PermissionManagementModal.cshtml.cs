...
using Aiwins.Rocket.PermissionManagement.Web.Utils;

namespace Aiwins.Rocket.PermissionManagement.Web.Pages.RocketPermissionManagement
{
    public class PermissionManagementModal : RocketPageModel
    {
        [Required]
        [HiddenInput]
        ...
        {
            ObjectMapperContext = typeof(RocketPermissionManagementWebModule);
