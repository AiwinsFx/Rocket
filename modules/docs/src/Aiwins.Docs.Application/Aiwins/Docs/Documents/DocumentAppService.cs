...
namespace Aiwins.Docs.Documents
{
    public class DocumentAppService : DocsAppServiceBase, IDocumentAppService
    {
        ...
        {
            var value = _configuration["Aiwins.Docs:DocumentCacheTimeoutInterval"];
        ...
        {
            var value = _configuration["Aiwins.Docs:DocumentResource.AbsoluteExpirationRelativeToNow"];
            if (value.IsNullOrEmpty())
            {
                return TimeSpan.FromHours(6);
            }
        ...
        {
            var value = _configuration["Aiwins.Docs:DocumentResource.SlidingExpiration"];
            if (value.IsNullOrEmpty())
            {
