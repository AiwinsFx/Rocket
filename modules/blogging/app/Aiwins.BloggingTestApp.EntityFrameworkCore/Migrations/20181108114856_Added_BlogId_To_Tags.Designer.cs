...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aiwins.Rocket.Identity.IdentityRoleClaim", b =>
                {
                    b.HasOne("Aiwins.Rocket.Identity.IdentityRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Aiwins.Rocket.Identity.IdentityUserClaim", b =>
                {
                    b.HasOne("Aiwins.Rocket.Identity.IdentityUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Aiwins.Blogging.Comments.Comment", b =>
                {
                    b.HasOne("Aiwins.Blogging.Posts.Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Aiwins.Blogging.Comments.Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("Aiwins.Blogging.Posts.PostTag", b =>
                {
                    ...
                    b.HasOne("Aiwins.Blogging.Tagging.Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
