...
describe('AccountService', () => {
  ...
  it('should send a GET to find tenant', () => {
    ...
    spectator.expectOne('https://aiwins.cn/api/rocket/multi-tenancy/tenants/by-name/test', HttpMethod.GET);
  });
  ...
  it('should send a POST to register API', () => {
    ...
    const req = spectator.expectOne('https://aiwins.cn/api/account/register', HttpMethod.POST);
