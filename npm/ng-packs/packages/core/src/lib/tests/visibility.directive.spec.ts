...
describe('VisibilityDirective', () => {
  ...
  describe('without content', () => {
    beforeEach(() => {
      spectator = createDirective('<div [rocketVisibility]></div>');
  ...
  describe('without mutation observer and with content', () => {
    beforeEach(() => {
      spectator = createDirective('<div [rocketVisibility]><p id="content">Content</p></div>');
      directive = spectator.directive;
    });
  ...
  describe('without mutation observer and with focused element', () => {
    beforeEach(() => {
      spectator = createDirective(
        '<div id="main" [rocketVisibility]="container"></div><div #container><p id="content">Content</p></div>',
      );
      directive = spectator.directive;
    });
  ...
  describe('without content and with focused element', () => {
    beforeEach(() => {
      spectator = createDirective('<div id="main" [rocketVisibility]="container"></div><div #container></div>');
      directive = spectator.directive;
    });
  ...
  describe('with mutation observer and with content', () => {
    beforeEach(() => {
      spectator = createDirective('<div [rocketVisibility]><div id="content">Content</div></div>');
      directive = spectator.directive;
    });
