...
export const PROFILE_STATE_DATA = {
  profile: { userName: 'admin', email: 'info@rocket.io', name: 'Admin' },
} as Profile.State;
...
describe('ProfileState', () => {
  ...
  describe('#GetProfile', () => {
    it('should call the profile service get method and update the state', () => {
      const mockData = { userName: 'test', email: 'test@rocket.io' };
  ...
  describe('#UpdateProfile', () => {
    it('should call the profile service update method and update the state', () => {
      const mockData = { userName: 'test2', email: 'test@rocket.io' };
