...
describe('PermissionDirective', () => {
  ...
  describe('with condition', () => {
    beforeEach(() => {
      spectator = createDirective(`<div id="test-element" [rocketPermission]="'test'">Testing Permission Directive</div>`);
  ...
  describe('without condition', () => {
    beforeEach(() => {
      spectator = createDirective('<div id="test-element" rocketPermission>Testing Permission Directive</div>');
      directive = spectator.directive;
    });
  ...
  describe('structural', () => {
    beforeEach(() => {
      spectator = createDirective(
        '<div id="test-element" *rocketPermission="condition">Testing Permission Directive</div>',
        { hostProps: { condition: '' } },
      );
      directive = spectator.directive;
    });
