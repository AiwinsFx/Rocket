...
export class TenantsComponent implements OnInit {
  ...
  onEditConnectionString(id: string) {
    this.store
      ...
      .subscribe(fetchedConnectionString => {
        ...
        this.openModal(
          'RocketTenantManagement::ConnectionStrings',
  ...
  editTenant(id: string) {
    this.store
      ...
      .subscribe(selected => {
        this.selected = selected;
        this.createTenantForm();
        this.openModal('RocketTenantManagement::Edit', this.tenantModalTemplate, 'saveTenant');
      });
  }
  ...
  delete(id: string, name: string) {
    this.confirmationService
      .warn(
        'RocketTenantManagement::TenantDeletionConfirmationMessage',
        'RocketTenantManagement::AreYouSure',
        {
