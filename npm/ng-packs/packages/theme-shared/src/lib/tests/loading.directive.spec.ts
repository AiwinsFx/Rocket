...
describe('LoadingDirective', () => {
  ...
  describe('default', () => {
    beforeEach(() => {
      spectator = createDirective('<div [rocketLoading]="loading">Testing Loading Directive</div>', {
  ...
  describe('with custom target', () => {
    ...
    beforeEach(() => {
      spectator = createDirective(
        '<div [rocketLoading]="loading" [rocketLoadingDelay]="delay" [rocketLoadingTargetElement]="target">Testing Loading Directive</div>',
        {
  ...
  describe('with a component selector', () => {
    beforeEach(() => {
      spectator = createDirective('<rocket-dummy [rocketLoading]="loading"></rocket-dummy>', {
        hostProps: { loading: true },
      });
    });
