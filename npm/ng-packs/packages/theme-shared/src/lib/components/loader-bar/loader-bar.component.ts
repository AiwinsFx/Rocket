...
@Component({
  selector: 'rocket-loader-bar',
  template: `
    <div id="rocket-loader-bar" [ngClass]="containerClass" [class.is-loading]="isLoading">
      <div
        class="rocket-progress"
...
export class LoaderBarComponent implements OnDestroy, OnInit {
  @Input()
  containerClass = 'rocket-loader-bar';
