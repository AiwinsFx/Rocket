...
namespace Aiwins.Rocket.Uow {
    public class UnitOfWork : IUnitOfWork, ITransientDependency {
        ...
        public UnitOfWork (IServiceProvider serviceProvider, IOptions<RocketUnitOfWorkDefaultOptions> options) {
        ...
        public void AddDatabaseApi (string key, IDatabaseApi api) {
            ...
            if (_databaseApis.ContainsKey (key)) {
                throw new RocketException ("There is already a database API in this unit of work with given key: " + key);
            }
        ...
        public void AddTransactionApi (string key, ITransactionApi api) {
            ...
            if (_transactionApis.ContainsKey (key)) {
                throw new RocketException ("There is already a transaction API in this unit of work with given key: " + key);
            }
        ...
        private void PreventMultipleComplete () {
            if (IsCompleted || _isCompleting) {
                throw new RocketException ("Complete is called before!");
            }
        }
