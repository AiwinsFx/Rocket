...
namespace Aiwins.Rocket.AutoMapper {
    public class RocketAutoMapperOptions {
        public List<Action<IRocketAutoMapperConfigurationContext>> Configurators { get; }

        public ITypeList<Profile> ValidatingProfiles { get; set; }

        public RocketAutoMapperOptions () {
            Configurators = new List<Action<IRocketAutoMapperConfigurationContext>> ();
