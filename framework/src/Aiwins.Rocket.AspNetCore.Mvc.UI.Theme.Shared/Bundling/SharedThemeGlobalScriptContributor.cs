...
namespace Aiwins.Rocket.AspNetCore.Mvc.UI.Theme.Shared.Bundling
{
    ...
    public class SharedThemeGlobalScriptContributor : BundleContributor
    {
        public override void ConfigureBundle(BundleConfigurationContext context)
        {
            ...
            {
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/jquery/jquery-extensions.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/jquery-form/jquery-form-extensions.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/jquery/widget-manager.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/bootstrap/dom-event-handlers.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/bootstrap/modal-manager.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/datatables/datatables-extensions.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/sweetalert/rocket-sweetalert.js",
                "/libs/aiwins/aspnetcore-mvc-ui-theme-shared/toastr/rocket-toastr.js"
            });
        }
    }
}