...
namespace Aiwins.Rocket.EventBus {
    public abstract class EventBusBase : IEventBus {
        ...
        protected virtual async Task TriggerHandlersAsync (Type eventType, object eventData, List<Exception> exceptions) {
            ...
            //此处实现了实现泛型参数继承，可参考 IEventDataWithInheritableGenericArgument
            ...
            using (var eventHandlerWrapper = asyncHandlerFactory.GetHandler ()) {
                try {
                    ...
                    if (ReflectionHelper.IsAssignableToGenericType (handlerType, typeof (ILocalEventHandler<>))) {
                        ...
                        throw new RocketException ("The object instance is not an event handler. Object type: " + handlerType.AssemblyQualifiedName);
                    }
