...
namespace Aiwins.Rocket.Cli.Commands
{
    public class NewCommand : IConsoleCommand, ITransientDependency
    {
        ...
        public async Task ExecuteAsync(CommandLineArgs commandLineArgs)
        {
            ...
            Aiwins.Rocket.IO.DirectoryHelper.CreateIfNotExists(outputFolder);
        ...
        public string GetUsageInfo()
        {
            ...
            sb.AppendLine("Usage:");
            sb.AppendLine("");
            sb.AppendLine("  rocket new <project-name> [options]");
            sb.AppendLine("");
            ...
            sb.AppendLine("-ts|--template-source <template-source>     (your local or network rocket template source)");
            ...
            sb.AppendLine("--local-framework-ref --rocket-path <your-local-rocket-repo-path>  (keeps local references to projects instead of replacing with NuGet package references)");
            sb.AppendLine("");
            sb.AppendLine("Examples:");
            sb.AppendLine("");
            sb.AppendLine("  rocket new Acme.BookStore");
            sb.AppendLine("  rocket new Acme.BookStore --tiered");
            sb.AppendLine("  rocket new Acme.BookStore -u angular");
            sb.AppendLine("  rocket new Acme.BookStore -u angular -d mongodb");
            sb.AppendLine("  rocket new Acme.BookStore -m none");
            sb.AppendLine("  rocket new Acme.BookStore -m react-native");
            sb.AppendLine("  rocket new Acme.BookStore -d mongodb");
            sb.AppendLine("  rocket new Acme.BookStore -d mongodb -o d:\\my-project");
            sb.AppendLine("  rocket new Acme.BookStore -t module");
            sb.AppendLine("  rocket new Acme.BookStore -t module --no-ui");
            sb.AppendLine("  rocket new Acme.BookStore -ts \"D:\\localTemplate\\rocket\"");
            sb.AppendLine("  rocket new Acme.BookStore -csf false");
        ...
        public static class Options
        {
            ...
            {
                public const string Long = "rocket-path";
            }
