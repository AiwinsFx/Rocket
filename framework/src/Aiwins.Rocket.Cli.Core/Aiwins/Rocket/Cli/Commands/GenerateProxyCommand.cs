...
namespace Aiwins.Rocket.Cli.Commands {
    public class GenerateProxyCommand : IConsoleCommand, ITransientDependency {
        ...
        private static string CreateType (JObject data, string returnValueType, string rootPath, List<string> modelIndexList, string controllerPathName) {
            ...
            if (returnValueType.StartsWith ("Aiwins.Rocket.Application.Dtos") ||
            ...
            if (baseType == "System.Enum" && (bool) type["isEnum"]) {
                ...
                foreach (var property in type["properties"]) {
                    ...
                    if (typeSimple.StartsWith ("Aiwins.Rocket")) {
        ...
        public string GetUsageInfo () {
            ...
            sb.AppendLine ("Usage:");
            sb.AppendLine ("");
            sb.AppendLine ("  rocket generate-proxy [options]");
            sb.AppendLine ("");
            ...
            sb.AppendLine ("");
            sb.AppendLine ("  rocket generate-proxy --apiUrl https://www.volosoft.com");
            sb.AppendLine ("");
