...
namespace Aiwins.Rocket.Cli.Commands.Services
{
    public class SourceCodeDownloadService : ITransientDependency
    {
        ...
        public async Task DownloadAsync(string moduleName, string outputFolder, string version, string gitHubLocalRepositoryPath, RocketCommandLineOptions options)
        {
