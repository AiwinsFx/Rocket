...
namespace Aiwins.Rocket.Cli.ProjectBuilding
{
    public class RemoteServiceExceptionHandler : IRemoteServiceExceptionHandler, ITransientDependency
    {
        ...
        public async Task EnsureSuccessfulHttpResponseAsync(HttpResponseMessage responseMessage)
        {
            ...
            var remoteServiceErrorMessage = await GetRocketRemoteServiceErrorAsync(responseMessage);
        ...
        public async Task<string> GetRocketRemoteServiceErrorAsync(HttpResponseMessage responseMessage)
        {
