...
namespace Aiwins.Rocket.Data {
    //TODO: 考虑移动到 a Aiwins.Rocket.Data.Filtering 命名空间下?
    ...
    public class DataFilter<TFilter> : IDataFilter<TFilter>
        where TFilter : class {
            ...
            private readonly RocketDataFilterOptions _options;

            private readonly AsyncLocal<DataFilterState> _filter;

            public DataFilter (IOptions<RocketDataFilterOptions> options) {
