...
using Aiwins.Rocket.AspNetCore.Mvc.UI.Bundling.Scripts;
using Aiwins.Rocket.AspNetCore.Mvc.UI.Bundling.Styles;
using Aiwins.Rocket.AspNetCore.Mvc.UI.Resources;
...
namespace Aiwins.Rocket.AspNetCore.Mvc.UI.Bundling
{
    public class BundleManager : IBundleManager, ITransientDependency
    {
        ...
        protected readonly RocketBundleContributorOptions ContributorOptions;
        ...
        public BundleManager(
            ...
            IOptions<RocketBundleContributorOptions> contributorOptions,
        ...
        protected virtual bool IsBundlingEnabled()
        {
            switch (Options.Mode)
            {
                ...
                default:
                    throw new RocketException($"Unhandled {nameof(BundlingMode)}: {Options.Mode}");
            }
        }
