...
namespace Aiwins.Rocket.Caching {
    ...
    public class DistributedCache<TCacheItem> : DistributedCache<TCacheItem, string>, IDistributedCache<TCacheItem>
        where TCacheItem : class {
            public DistributedCache (
                IOptions<RocketDistributedCacheOptions> distributedCacheOption,
    ...
    public class DistributedCache<TCacheItem, TCacheKey> : IDistributedCache<TCacheItem, TCacheKey>
        where TCacheItem : class {
            ...
            private readonly RocketDistributedCacheOptions _distributedCacheOption;
            ...
            public virtual void Refresh (
                TCacheKey key, bool? hideErrors = null) {
                hideErrors = hideErrors ?? _distributedCacheOption.HideErrors;
