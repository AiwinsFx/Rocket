...
namespace Aiwins.Rocket.EntityFrameworkCore.Modeling {
    public static class RocketEntityTypeBuilderExtensions {
        ...
        public static void TryConfigureExtraProperties (this EntityTypeBuilder b) {
            ...
            b.Property<Dictionary<string, object>> (nameof (IHasExtraProperties.ExtraProperties))
                ...
                .Metadata.SetValueComparer (new RocketDictionaryValueComparer<string, object> ());
        ...
        //TODO: 添加其他的实体接口配置 (IAuditedObject<TUser>...)
    }
}