...
namespace Aiwins.Rocket.Authorization.Permissions {
    public class PermissionDefinitionContext : IPermissionDefinitionContext {
        ...
        public virtual PermissionGroupDefinition GetGroup ([NotNull] string name) {
            ...
            if (group == null) {
                throw new RocketException ($"Could not find a permission definition group with the given name: {name}");
            }
        ...
        public virtual void RemoveGroup (string name) {
            ...
            if (!Groups.ContainsKey (name)) {
                throw new RocketException ($"Not found permission group with name: {name}");
            }
