...
namespace Aiwins.Rocket.AspNetCore.Mvc.UI.Widgets
{
    ...
    {
        public const string HttpContextItemName = "__RocketCurrentWidgets";
        ...
        private List<WidgetDefinition> GetWidgetList()
        {
            ...
            if (httpContext == null)
            {
                throw new RocketException($"{typeof(PageWidgetManager).AssemblyQualifiedName} should be used in a web request! Can not get IHttpContextAccessor.HttpContext.");
            }
