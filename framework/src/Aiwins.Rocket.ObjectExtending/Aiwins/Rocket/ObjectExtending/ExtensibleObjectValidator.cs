...
namespace Aiwins.Rocket.ObjectExtending {
    public static class ExtensibleObjectValidator {
        public static void CheckValue (
            [NotNull] IHasExtraProperties extensibleObject, [NotNull] string propertyName, [CanBeNull] object value) {
            ...
            if (validationErrors.Any ()) {
                throw new RocketValidationException (validationErrors);
            }
        }

        public static bool IsValid (
            [NotNull] IHasExtraProperties extensibleObject, [CanBeNull] ValidationContext objectValidationContext = null) {
        ...
        public static bool IsValid (
            [NotNull] IHasExtraProperties extensibleObject, [NotNull] string propertyName, [CanBeNull] object value, [CanBeNull] ValidationContext objectValidationContext = null) {
            return GetValidationErrors (
                extensibleObject,
                propertyName,
                value,
        ...
        public static void AddValidationErrors (
            [NotNull] IHasExtraProperties extensibleObject, [NotNull] List<ValidationResult> validationErrors, [CanBeNull] ValidationContext objectValidationContext = null) {
        ...
        public static void AddValidationErrors (
            [NotNull] IHasExtraProperties extensibleObject, [NotNull] List<ValidationResult> validationErrors, [NotNull] string propertyName, [CanBeNull] object value, [CanBeNull] ValidationContext objectValidationContext = null) {
            Check.NotNull (extensibleObject, nameof (extensibleObject));
            Check.NotNull (validationErrors, nameof (validationErrors));
