...
namespace Aiwins.Rocket.ObjectExtending {
    public class ObjectExtensionManager {
        ...
        public virtual ObjectExtensionManager AddOrUpdate (
            [NotNull] Type[] types, [CanBeNull] Action<ObjectExtensionInfo> configureAction = null) {
        ...
        [NotNull]
        public virtual ObjectExtensionManager AddOrUpdate (
            [NotNull] Type type, [CanBeNull] Action<ObjectExtensionInfo> configureAction = null) {
