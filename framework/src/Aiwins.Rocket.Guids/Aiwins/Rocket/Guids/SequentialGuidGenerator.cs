...
namespace Aiwins.Rocket.Guids {
    /* 代码参考jhtodd/SequentialGuid https://github.com/jhtodd/SequentialGuid/blob/master/SequentialGuid/Classes/SequentialGuid.cs */

    /// <summary>
    /// 实现接口IGuidGenerator <see cref="IGuidGenerator"/>
    /// 配置参数 <see cref="RocketSequentialGuidGeneratorOptions"/>。
    /// </summary>
    public class SequentialGuidGenerator : IGuidGenerator, ITransientDependency {
        public RocketSequentialGuidGeneratorOptions Options { get; }

        private static readonly RandomNumberGenerator RandomNumberGenerator = RandomNumberGenerator.Create ();

        public SequentialGuidGenerator (IOptions<RocketSequentialGuidGeneratorOptions> options) {
