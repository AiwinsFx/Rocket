...
namespace Microsoft.AspNetCore.Builder {
    public static class RocketAspNetCoreApplicationBuilderExtensions {
        /// <summary>
        /// Maps endpoints configured with the <see cref="RocketEndpointRouterOptions"/>.
        ...
        public static IApplicationBuilder UseConfiguredEndpoints (
            ...
            var options = app.ApplicationServices
                .GetRequiredService<IOptions<RocketEndpointRouterOptions>> ()
                .Value;
