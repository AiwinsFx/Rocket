...
namespace Aiwins.Rocket.AspNetCore.ExceptionHandling {
    public class DefaultExceptionToErrorInfoConverter : IExceptionToErrorInfoConverter, ITransientDependency {
        ...
        protected RocketExceptionLocalizationOptions LocalizationOptions { get; }
        protected IStringLocalizerFactory StringLocalizerFactory { get; }
        protected IStringLocalizer<RocketUiResource> L { get; }
        protected IServiceProvider ServiceProvider { get; }

        public DefaultExceptionToErrorInfoConverter (
            IOptions<RocketExceptionLocalizationOptions> localizationOptions,
            IStringLocalizerFactory stringLocalizerFactory,
            IStringLocalizer<RocketUiResource> rocketUiStringLocalizer,
            IServiceProvider serviceProvider) {
            ServiceProvider = serviceProvider;
            StringLocalizerFactory = stringLocalizerFactory;
            L = rocketUiStringLocalizer;
        ...
        protected virtual RemoteServiceErrorInfo CreateErrorInfoWithoutCode (Exception exception) {
            ...
            if (exception is RocketAuthorizationException) {
                var authorizationException = exception as RocketAuthorizationException;
        ...
        protected virtual Exception TryToGetActualException (Exception exception) {
            if (exception is AggregateException && exception.InnerException != null) {
                ...
                if (aggException.InnerException is IUserFriendlyException ||
                    aggException.InnerException is RocketValidationException ||
                    aggException.InnerException is EntityNotFoundException ||
                    aggException.InnerException is RocketAuthorizationException ||
        ...
        protected virtual RemoteServiceErrorInfo CreateDetailedErrorInfoFromException (Exception exception) {
            ...
            if (exception is RocketValidationException) {
                errorInfo.ValidationErrors = GetValidationErrorInfos (exception as RocketValidationException);
            }
        ...
        protected virtual void AddExceptionToDetails (Exception exception, StringBuilder detailBuilder) {
            ...
            //Additional info for RocketValidationException
            if (exception is RocketValidationException) {
                var validationException = exception as RocketValidationException;
