...
namespace Aiwins.Rocket.VirtualFileSystem {
    public class VirtualFileProvider : IVirtualFileProvider, ISingletonDependency {
        ...
        private readonly RocketVirtualFileSystemOptions _options;

        public VirtualFileProvider (
            IOptions<RocketVirtualFileSystemOptions> options,
        ...
        protected class InternalVirtualFileProvider : DictionaryBasedFileProvider {
            ...
            public InternalVirtualFileProvider (RocketVirtualFileSystemOptions options) {
                _options = options;
