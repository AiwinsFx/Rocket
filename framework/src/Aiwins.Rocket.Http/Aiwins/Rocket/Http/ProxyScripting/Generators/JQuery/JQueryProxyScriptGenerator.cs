...
namespace Aiwins.Rocket.Http.ProxyScripting.Generators.JQuery {
    //TODO: Add rocket.ajax, rocket.utils... etc.

    public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency {
        //TODO: Should move this to Ddd package by adding an option to RocketHttpAbstractions module. Also duplicated of ApplicationService.CommonPostfixes
        ...
        public string CreateScript (ApplicationApiDescriptionModel model) {
            ...
            script.AppendLine ("/* This file is automatically generated by Rocket framework to use MVC Controllers from javascript. */");
            script.AppendLine ();
        ...
        private static void AddControllerScript (StringBuilder script, ControllerApiDescriptionModel controller) {
            ...
            script.AppendLine ($"    rocket.utils.createNamespace(window, '{controllerName}');");
        ...
        private static void AddActionScript (StringBuilder script, string controllerName, ActionApiDescriptionModel action, string normalizedActionName) {
            ...
            script.AppendLine ("      return rocket.ajax($.extend(true, {");
        ...
        private static void AddAjaxCallParameters (StringBuilder script, ActionApiDescriptionModel action) {
            ...
            script.AppendLine ("        url: rocket.appPath + '" + ProxyScriptingHelper.GenerateUrlWithParameters (action) + "',");
