...
namespace Aiwins.Rocket.Http {
    public static class HttpMethodHelper {
        ...
        public static Dictionary<string, string[]> ConventionalPrefixes { get; set; } = new Dictionary<string, string[]> { { "GET", new [] { "GetList", "GetAll", "Get" } },
            { "PUT", new [] { "Put", "Update" } },
        ...
        public static HttpMethod ConvertToHttpMethod (string httpMethod) {
            switch (httpMethod.ToUpperInvariant ()) {
                ...
                default:
                    throw new RocketException ("Unknown HTTP METHOD: " + httpMethod);
            }
        }
    }
}