...
namespace Aiwins.Rocket.TextTemplating {
    public class TemplateContentProvider : ITemplateContentProvider, ITransientDependency {
        ...
        public RocketTextTemplatingOptions Options { get; }
        ...
        public virtual Task<string> GetContentOrNullAsync (
            [NotNull] string templateName, [CanBeNull] string cultureName = null,
        ...
        public virtual async Task<string> GetContentOrNullAsync (
            [NotNull] TemplateDefinition templateDefinition, [CanBeNull] string cultureName = null,
            bool tryDefaults = true,
            bool useCurrentCultureIfCultureNameIsNull = true) {
            ...
            if (!Options.ContentContributors.Any ()) {
                throw new RocketException (
                    $"No template content contributor was registered. Use {nameof(RocketTextTemplatingOptions)} to register contributors!"
                );
            }
