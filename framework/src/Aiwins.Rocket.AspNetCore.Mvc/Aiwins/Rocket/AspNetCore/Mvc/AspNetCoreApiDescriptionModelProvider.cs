...
using Aiwins.Rocket.AspNetCore.Mvc.Utils;
...
namespace Aiwins.Rocket.AspNetCore.Mvc {
    public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ITransientDependency {
        ...
        private readonly RocketApiDescriptionModelOptions _modelOptions;

        public AspNetCoreApiDescriptionModelProvider (
            IApiDescriptionGroupCollectionProvider descriptionProvider,
            IOptions<RocketAspNetCoreMvcOptions> options,
            IOptions<RocketApiDescriptionModelOptions> modelOptions) {
