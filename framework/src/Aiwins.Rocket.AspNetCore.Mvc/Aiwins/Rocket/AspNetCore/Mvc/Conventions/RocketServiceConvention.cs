...
namespace Aiwins.Rocket.AspNetCore.Mvc.Conventions {
    public class RocketServiceConvention : IRocketServiceConvention, ITransientDependency {
        private readonly RocketAspNetCoreMvcOptions _options;

        public RocketServiceConvention (IOptions<RocketAspNetCoreMvcOptions> options) {
