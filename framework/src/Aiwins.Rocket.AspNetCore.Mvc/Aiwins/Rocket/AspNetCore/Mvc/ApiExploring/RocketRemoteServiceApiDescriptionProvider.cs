...
namespace Aiwins.Rocket.AspNetCore.Mvc.ApiExploring {
    public class RocketRemoteServiceApiDescriptionProvider : IApiDescriptionProvider, ITransientDependency {
        private readonly IModelMetadataProvider _modelMetadataProvider;
        private readonly MvcOptions _mvcOptions;
        private readonly RocketRemoteServiceApiDescriptionProviderOptions _options;

        public RocketRemoteServiceApiDescriptionProvider (
            IModelMetadataProvider modelMetadataProvider,
            IOptions<MvcOptions> mvcOptionsAccessor,
            IOptions<RocketRemoteServiceApiDescriptionProviderOptions> optionsAccessor) {
