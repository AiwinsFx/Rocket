...
{
    public class RocketDynamicFormTagHelperService : RocketTagHelperService<RocketDynamicFormTagHelper>
    {
        private readonly HtmlEncoder _htmlEncoder;
        private readonly IHtmlGenerator _htmlGenerator;
        private readonly IServiceProvider _serviceProvider;

        public RocketDynamicFormTagHelperService(
        ...
        protected virtual void SetContent(TagHelperContext context, TagHelperOutput output, List<FormGroupItem> items, string childContent)
        {
            ...
            if (childContent.Contains(RocketFormContentPlaceHolder))
            {
                childContent = childContent.Replace(RocketFormContentPlaceHolder, contentBuilder.ToString());
            }
            else
            {
        ...
        protected virtual RocketTagHelper GetSelectGroupTagHelper(TagHelperContext context, TagHelperOutput output, ModelExpression model)
        {
            return IsRadioGroup(model.ModelExplorer) ? 
                GetRocketRadioInputTagHelper(model) :
        ...
        {
            return explorer.GetAttribute<RocketRadioButton>() != null;
        }
    }
}