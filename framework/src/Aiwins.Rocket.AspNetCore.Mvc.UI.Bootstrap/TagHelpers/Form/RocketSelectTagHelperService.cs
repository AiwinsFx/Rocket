...
{
    public class RocketSelectTagHelperService : RocketTagHelperService<RocketSelectTagHelper>
    {
        private readonly IHtmlGenerator _generator;
        private readonly HtmlEncoder _encoder;
        private readonly IRocketTagHelperLocalizer _tagHelperLocalizer;

        public RocketSelectTagHelperService(IHtmlGenerator generator, HtmlEncoder encoder, IRocketTagHelperLocalizer tagHelperLocalizer)
        {
        ...
        protected virtual string GetSize(TagHelperContext context, TagHelperOutput output)
        {
            ...
            {
                case RocketFormControlSize.Small:
                    return "custom-select-sm";
                case RocketFormControlSize.Medium:
                    return "custom-select-md";
                case RocketFormControlSize.Large:
