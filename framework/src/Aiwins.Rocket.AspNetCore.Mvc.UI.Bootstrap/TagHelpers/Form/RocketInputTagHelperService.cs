...
{
    public class RocketInputTagHelperService : RocketTagHelperService<RocketInputTagHelper>
    {
        private readonly IHtmlGenerator _generator;
        private readonly HtmlEncoder _encoder;
        private readonly IRocketTagHelperLocalizer _tagHelperLocalizer;

        public RocketInputTagHelperService(IHtmlGenerator generator, HtmlEncoder encoder, IRocketTagHelperLocalizer tagHelperLocalizer)
        {
