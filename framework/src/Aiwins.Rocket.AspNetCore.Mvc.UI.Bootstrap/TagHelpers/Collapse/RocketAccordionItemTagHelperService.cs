...
{
    public class RocketAccordionItemTagHelperService : RocketTagHelperService<RocketAccordionItemTagHelper>
    {
        ...
        protected virtual string GetAccordionContentItem(TagHelperContext context, TagHelperOutput output, string content)
        {
            ...
            return "<div id=\"" + GetContentId() + "\" class=\"collapse"+ show + "\" aria-labelledby=\"" + GetHeadingId() + "\" data-parent=\"#" + RocketAccordionParentIdPlaceholder + "\">" + Environment.NewLine +
