...
{
    public class RocketAccordionTagHelperService : RocketTagHelperService<RocketAccordionTagHelper>
    {
        ...
        protected virtual string GetContent(List<string> items)
        {
            ...
            {
                var content = item.Replace(RocketAccordionParentIdPlaceholder, TagHelper.Id);
