...
{
    public class RocketColumnTagHelper : RocketTagHelper<RocketColumnTagHelper, RocketColumnTagHelperService>
    {
       // public string Size { get; set; }
        ...
        public RocketColumnTagHelper(RocketColumnTagHelperService tagHelperService)
