...
{
    public class RocketBreadcrumbTagHelperService : RocketTagHelperService<RocketBreadcrumbTagHelper>
    {
        ...
        {
            return item.Active ?
                item.Html.Replace(RocketBreadcrumbItemActivePlaceholder, " active") :
                item.Html.Replace(RocketBreadcrumbItemActivePlaceholder, "");
        }
