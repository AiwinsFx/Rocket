...
{
    public class RocketBorderTagHelperService : RocketTagHelperService<RocketBorderTagHelper>
    {
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            var borderAttributeAsString = TagHelper.RocketBorder.ToString().ToLowerInvariant();
