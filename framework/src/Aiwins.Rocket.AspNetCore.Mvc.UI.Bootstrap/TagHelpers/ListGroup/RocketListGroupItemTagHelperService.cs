...
{
    public class RocketListGroupItemTagHelperService : RocketTagHelperService<RocketListGroupItemTagHelper>
    {
        ...
        protected virtual void SetTagNameAndAttributes(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (TagHelper.TagType == RocketListItemTagType.Default)
            {
                output.TagName = "li";
            }
            else if (TagHelper.TagType == RocketListItemTagType.Link)
            {
                output.TagName = "a";
                output.Attributes.AddClass("list-group-item-action");
                output.Attributes.Add("href", TagHelper.Href);
            }
            else if (TagHelper.TagType == RocketListItemTagType.Button)
            {
        ...
        protected virtual void SetCommonTagNameAndAttributes(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (TagHelper.Type != RocketListItemType.Default)
            {
        ...
        protected virtual void MakeLinkIfHrefIsSet()
        {
            ...
            {
                TagHelper.TagType = RocketListItemTagType.Link;
            }
        }
    }
}