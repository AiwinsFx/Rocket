...
{
    public class RocketPaginationTagHelperService : RocketTagHelperService<RocketPaginationTagHelper>
    {
        private readonly IHtmlGenerator _generator;
        private readonly HtmlEncoder _encoder;
        private readonly IRocketTagHelperLocalizer _tagHelperLocalizer;

        public RocketPaginationTagHelperService(IHtmlGenerator generator, HtmlEncoder encoder, IRocketTagHelperLocalizer tagHelperLocalizer)
        {
        ...
        {
            var localizer = _tagHelperLocalizer.GetLocalizer(typeof(RocketUiResource));
