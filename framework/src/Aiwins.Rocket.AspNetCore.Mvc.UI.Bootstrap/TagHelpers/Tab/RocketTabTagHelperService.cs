...
{
    public class RocketTabTagHelperService : RocketTagHelperService<RocketTabTagHelper>
    {
        ...
        protected virtual string GetTabHeaderItem(TagHelperContext context, TagHelperOutput output)
        {
            ...
            return "<li class=\"nav-item\"><a class=\"nav-link " + classAttributesAsString + " " + RocketTabItemActivePlaceholder + "\" id=\"" + id + "\" data-toggle=\"" + TabItemsDataTogglePlaceHolder + "\" href=\"#" + link + "\" role=\"tab\" aria-controls=\"" + control + "\" aria-selected=\"" + RocketTabItemSelectedPlaceholder + "\" "+ otherAttributesAsString + ">" +
                   title +
                   "</a></li>";
        }
