...
{
    public class RocketCarouselItemTagHelperService : RocketTagHelperService<RocketCarouselItemTagHelper>
    {
        private readonly HtmlEncoder _encoder;

        public RocketCarouselItemTagHelperService(HtmlEncoder encoder)
        {
            _encoder = encoder;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.AddClass(RocketCarouselItemActivePlaceholder);
