...
{
    public class RocketCarouselTagHelperService : RocketTagHelperService<RocketCarouselTagHelper>
    {
        ...
        {
            item.Html = item.Html.Replace(RocketCarouselItemActivePlaceholder, item.Active ? "active" : "");
        }
