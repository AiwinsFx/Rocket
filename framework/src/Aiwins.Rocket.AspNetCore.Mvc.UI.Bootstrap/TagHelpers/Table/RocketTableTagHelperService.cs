...
{
    public class RocketTableTagHelperService : RocketTagHelperService<RocketTableTagHelper>
    {
        ...
        protected virtual void SetBorderStyle(TagHelperContext context, TagHelperOutput output)
        {
            ...
            {
                case RocketTableBorderStyle.Default:
                    return;
                case RocketTableBorderStyle.Bordered:
                    output.Attributes.AddClass("table-bordered");
                    return;
                case RocketTableBorderStyle.Borderless:
