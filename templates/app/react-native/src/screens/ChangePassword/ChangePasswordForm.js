...
const ValidationSchema = Yup.object().shape({
  currentPassword: Yup.string().required('RocketAccount::ThisFieldIsRequired.'),
  newPassword: Yup.string().required('RocketAccount::ThisFieldIsRequired.'),
});
            ...
            <Content px20>
              <Form>
                <InputGroup rocketInputGroup>
                  <Label rocketLabel>{i18n.t('RocketIdentity::DisplayName:CurrentPassword')}</Label>
                  <Item rocketInput>
                    <Input
                ...
                <InputGroup rocketInputGroup>
                  <Label rocketLabel>{i18n.t('RocketIdentity::DisplayName:NewPassword')}</Label>
                  <Item rocketInput>
                    <Input
                      ref={newPasswordRef}
                      returnKeyType="done"
