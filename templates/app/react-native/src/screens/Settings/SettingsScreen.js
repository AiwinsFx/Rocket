    ...
    <View>
      <List>
        ...
        <ListItem
          ...
          <Body>
            <Text>{i18n.t('RocketUi::ChangePassword')}</Text>
          </Body>
          <Right>
            <Icon active name="arrow-forward" />
          </Right>
        ...
        <ListItem itemDivider />
        <ListItem itemDivider>
          <Label rocketLabel style={{ marginBottom: 0 }}>
            {i18n.t('RocketUi::Language')}
          </Label>
        </ListItem>
        <ListItem noIndent icon style={{ backgroundColor: '#fff' }}>
          <Body>
            <Picker
              mode="dropdown"
              iosHeader={i18n.t('RocketUi::Language')}
        ...
        <Button
          ...
          <Text>{i18n.t('RocketAccount::Logout')}</Text>
        </Button>
      </List>
    </View>
  );
