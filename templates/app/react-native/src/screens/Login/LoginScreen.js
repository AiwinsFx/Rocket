...
const ValidationSchema = Yup.object().shape({
  ...
  password: Yup.string().required('RocketAccount::ThisFieldIsRequired.'),
});
            ...
            {({ handleChange, handleBlur, handleSubmit, values, errors }) => (
              <Form>
                <InputGroup rocketInputGroup>
                  <Label rocketLabel>{i18n.t('RocketAccount::UserNameOrEmailAddress')}</Label>
                  <Input
                    rocketInput
                ...
                <InputGroup rocketInputGroup>
                  <Label rocketLabel>{i18n.t('RocketAccount::Password')}</Label>
                  <Item rocketInput>
                    <Input
                ...
                <View style={{ marginTop: 20, alignItems: 'center' }}>
                  <Button rocketButton onPress={handleSubmit}>
                    <Text>{i18n.t('RocketAccount::Login')}</Text>
                  </Button>
                </View>
              </Form>
            )}
