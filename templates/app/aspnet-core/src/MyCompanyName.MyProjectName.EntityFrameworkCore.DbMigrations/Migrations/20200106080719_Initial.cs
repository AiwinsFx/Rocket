        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderScope = table.Column<string>(maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullPySpelling = table.Column<string>(maxLength: 128, nullable: true),
                    FirstPySpelling = table.Column<string>(maxLength: 32, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullPySpelling = table.Column<string>(nullable: true),
                    FirstPySpelling = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyDisplayName = table.Column<string>(maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RocketPermissionGrants_Name_ProviderName_ProviderScope_ProviderKey",
                table: "RocketPermissionGrants",
                columns: new[] { "Name", "ProviderName", "ProviderScope", "ProviderKey" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RocketUsers_PhoneNumber",
                table: "RocketUsers",
                column: "PhoneNumber");
